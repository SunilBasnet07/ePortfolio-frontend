...
const ProjectCard = ({ project }) => {
  ...
  const demoProject = {
    ...
    imageUrl: project?.imgeUrl || projectImage, // Using null to trigger placeholder
  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="flex space-x-3 mt-auto">
          ...
          <div className="relative">
            ...
            >
              <button onClick={handleDelete} className="bg-red-500 p-1 rounded-md hover:bg-red-600 transition"><Trash2 /></button>
              <button className="bg-blue-500 p-1 rounded-md hover:bg-blue-600 transition"><Pencil /></button>
            </div>
          </div>
      ...
      <Modal title="Delete Product" showModal={showDeleteModal} setShowModal={setShowDeleteModal}>
        <div className='flex flex-col gap-7 mt-5'>
          <p className='font-Nunito-Bold'>Do you want to sure delete  product?</p>
          <div className='flex justify-between items-center'>
            ...
            <button className='px-2 py-1 font-Nunito-Bold rounded-sm text-white bg-blue-500 hover:bg-blue-600'>Confirm</button>
          </div>
        </div>
