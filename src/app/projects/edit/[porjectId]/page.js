      ...
      <div className="container mx-auto max-w-4xl relative">
        ...
        >
          <div className="flex items-center mb-4">
            ...
            <h1 className="text-3xl font-Poppins-Bold text-white">Edit Project</h1>
          </div>
          <p className="text-indigo-300 ml-4 pl-4 border-l border-indigo-500/30 font-Nunito">
            Showcase your work by edit a project in your portfolio. Fill in the details below to get started.
          </p>
        </motion.div>
        ...
        >
          <ProjectForm isEditing={true} project={project} />
        </motion.div>
